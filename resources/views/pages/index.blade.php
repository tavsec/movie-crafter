    ...
    @volt('home')
        <div class="relative flex flex-col items-center justify-center w-full h-auto overflow-hidden" x-cloak>
            ...
            <div class="flex items-center w-full max-w-6xl px-8 pt-12 pb-20 mx-auto">
                <div class="container relative max-w-4xl mx-auto mt-5 text-center sm:mt-8 lg:mt-12">
                    ...
                    <h1 class="mt-5 text-4xl font-light leading-tight tracking-tight text-center dark:text-white text-slate-800 sm:text-5xl md:text-8xl">AI Movie Script<br> & <br> Storyboard Generator.</h1>
                    <p class="w-full max-w-2xl mx-auto mt-8 text-lg dark:text-white/60 text-slate-500">Bring your movie ideas to life with our AI-powered tool! Simply input a title, description, and genre, and watch as the AI crafts a unique script and generates stunning storyboard images.</p>
