...
return [
    "key" => env("OPENAI_KEY"),
    "system_prompt" => "
        You are assistant, which will generate a full movie script, based on the short description of a movie, and images, which will represent a visual mood board, which you should also take into consideration. Generate full script, including dialogue and scene descriptions.
